...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (cateringForm) {
    cateringForm.addEventListener('submit', (e) => {
      ...
      alert(`Tack för din förfrågan, ${name}!\n\nVi har tagit emot din bokningsförfrågan för ${guests} den ${date}.\nVi kontaktar dig på ${phone} inom kort för att bekräfta meny och detaljer.`);
      cateringForm.reset();
    });
  }
